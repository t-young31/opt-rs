...
impl EnergyFunction for LennardJones12x6 {
    ...
    fn involves_idxs(&self, idxs: Vec<usize>) -> bool { i_j_are_in(self.i, self.j, idxs) }
...
impl EnergyFunction for RepulsiveInverseDistance {
    ...
    fn force_constant(&self) -> f64 { self.c }
...
fn i_j_are_in(i: usize, j: usize, idxs: Vec<usize>) -> bool {
    idxs.len() == 2 && AtomPair{i, j} == AtomPair{i: idxs[0], j: idxs[1]}
}
